...
class InvalidBaseRateException(message: String = INVALID_BASE_RATE) : DomainException(message)
class InvalidDistanceException(message: String = INVALID_DISTANCE) : DomainException(message)
class InvalidDelayException(message: String = INVALID_DELAY) : DomainException(message)
class InvalidCostPerKmException(message: String = INVALID_COST_PER_KM) : DomainException(message)
class InvalidWarehouseNameException(message: String = INVALID_WAREHOUSE_NAME) : DomainException(message)
